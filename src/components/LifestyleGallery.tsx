  ...
  const items: GalleryItem[] = [
    {
      id: 1,
      url: images.ascoli,
      caption: 'Piazza del Popolo places Italian study inside the daily life of Ascoli Piceno.',
      captionIT: 'Piazza del Popolo colloca lo studio dell italiano nella vita quotidiana di Ascoli Piceno.',
      span: 'md:col-span-7',
      position: '50% 50%',
    },
    {
    ...
    },
    {
      ...
      caption: 'Conversation often continues around a table, not only in the classroom.',
      captionIT: 'La conversazione continua spesso attorno a un tavolo, non solo in aula.',
      span: 'md:col-span-5',
      position: '50% 48%',
    },
    {
      ...
      caption: 'Small groups keep the rhythm personal, adult, and conversational.',
      captionIT: 'I piccoli gruppi mantengono un ritmo personale, adulto e comunicativo.',
