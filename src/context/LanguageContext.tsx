...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'hero.salon_title': 'Official Address',
    ...
    'why.focus_1_desc':
      'The official school profile highlights qualified teachers and a director with long experience in Italian language teaching.',
    ...
    'courses.section_tag': 'Official Course Formats',
    'courses.section_title_part1': 'Choose the pace',
    'courses.section_title_italic': 'that fits your stay.',
    'courses.section_desc':
      'Course information below follows the school publication for 2024/2025: standard, intensive, individual, extensive, teacher-refresher, and custom formats.',
    ...
    'ascoli.image_title': 'The travertine heart of Ascoli Piceno',
    'ascoli.image_desc':
    ...
    'ascoli.gems_tag': 'Official Highlights',
    ...
    'testimonials.based_on': 'Published by Accademia Internazionale',
    'testimonials.google_rating': 'Official Method',
    ...
    'testimonials.story_label': 'Official Quote',
    ...
    'form.success_desc': 'Your inquiry has been noted. Please also contact the school directly for official booking confirmation.',
  ...
  IT: {
    ...
    'hero.salon_title': 'Indirizzo ufficiale',
    'hero.salon_desc': 'Corso Vittorio Emanuele, 27 - 63100 Ascoli Piceno, Italia.',
    ...
    'why.focus_1_desc':
      'Il profilo ufficiale della scuola evidenzia docenti qualificati e una direzione con lunga esperienza.',
    ...
    'courses.section_tag': 'Formati ufficiali',
    'courses.section_title_part1': 'Scegli il ritmo',
    'courses.section_title_italic': 'adatto al tuo soggiorno.',
    'courses.section_desc':
      'Le informazioni seguono la pubblicazione della scuola per il 2024/2025: corsi standard, intensivi, individuali, estensivi, aggiornamento docenti e su misura.',
    ...
    'ascoli.image_tag': 'Piazza del Popolo',
    'ascoli.image_title': 'Il cuore in travertino di Ascoli Piceno',
    ...
    'ascoli.gems_tag': 'Punti ufficiali',
    ...
    'testimonials.based_on': 'Pubblicata da Accademia Internazionale',
    'testimonials.google_rating': 'Metodo ufficiale',
    'testimonials.trustpilot_status': 'Servizi della scuola',
    'testimonials.video_diary': 'Accademia',
    'testimonials.video_quote': '"Open up to the world"',
    'testimonials.story_label': 'Citazione ufficiale',
    ...
    'form.success_title': 'Grazie',
    'form.success_desc': 'La richiesta e stata annotata. Contatta anche la scuola per conferma ufficiale.',
