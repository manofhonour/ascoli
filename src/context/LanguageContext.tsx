...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'courses.explore_details': 'Explore Details',
    'courses.curriculum_highlights': 'Curriculum Highlights',
  ...
  IT: {
    ...
    'courses.explore_details': 'Esplora i Dettagli',
    'courses.curriculum_highlights': 'Punti Salienti del Programma',
    'courses.enquire_now': 'Richiedi Ora',
