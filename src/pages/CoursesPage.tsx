        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-light text-charcoal-950">{activeCourse.name}</h2>
              <p className="text-xs md:text-sm text-charcoal-800 font-light leading-relaxed">{activeCourse.description}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-travertine-200">
              <div className="space-y-2">
                ...
                <h4 className="font-serif text-sm text-charcoal-950">Duration</h4>
                <p className="text-[11px] text-charcoal-800 font-light leading-relaxed">{activeCourse.duration}</p>
              </div>
              <div className="space-y-2">
                <Compass className="w-5 h-5 text-olive-800" />
                <h4 className="font-serif text-sm text-charcoal-950">Weekly Rhythm</h4>
                <p className="text-[11px] text-charcoal-800 font-light leading-relaxed">{activeCourse.hoursPerWeek}</p>
              </div>
              <div className="space-y-2">
                <Euro className="w-5 h-5 text-olive-800" />
                <h4 className="font-serif text-sm text-charcoal-950">Price</h4>
                <p className="text-[11px] text-charcoal-800 font-light leading-relaxed">{activeCourse.price}</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 bg-travertine-100 border border-travertine-200 p-8 md:p-10 shadow-xl space-y-6">
            ...
            <div className="space-y-4 pt-2">
              {activeCourse.highlights.map((detail) => (
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            {culturalOfferings.map((item) => (
              <div key={item.title} className="bg-travertine-50 border border-travertine-200 p-6 space-y-2">
                ...
                <h4 className="font-serif text-base text-charcoal-950 font-semibold">{item.title}</h4>
                <p className="text-[11px] text-charcoal-800 font-light leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
