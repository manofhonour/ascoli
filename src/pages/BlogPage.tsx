...
export default function BlogPage() {
  ...
  const posts: BlogPost[] = [
    {
      id: 'courses',
      title: 'Choosing the right Italian course in Ascoli Piceno',
      excerpt: 'A concise guide to standard, intensive, individual, extensive, teacher-refresher, and custom-made course formats.',
      category: 'Courses',
      date: 'Updated 2026',
    ...
    {
      id: 'ascoli',
      title: 'Why Ascoli Piceno works as a language setting',
      excerpt: 'Ascoli offers history, culture, local food, festivals, and access to the Marche region.',
      category: 'Ascoli',
      date: 'Updated 2026',
      author: 'Accademia Italiana',
      readTime: '4 min read',
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-2 text-xs text-charcoal-800 font-light">
                    <div className="flex items-center gap-2">
                      ...
                      <span>By <span className="font-semibold text-charcoal-950">{selectedPost.author}</span></span>
                    </div>
                    <span>-</span>
